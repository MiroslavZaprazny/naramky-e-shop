<x-app-layout>
    <div class="px-24 py-4">
        <div class="max-w-xs mx-auto">
            ...
            <form action={{ route('bracelet.store') }} method="post" class="mt-8" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-col space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" class="border w-96 h-40 px-2 py-2 resize-none rounded-2xl">{{ old('description') }}</textarea>
