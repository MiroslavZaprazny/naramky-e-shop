<x-app-layout>
    <div class="flex justify-center">
        <form method="POST" action="" class="max-w-3xl ml-72">
            <div class="progress-bar relative flex justify-between mb-12">
                <div class="progress relative flex justify-between" id="progress"></div>
                <div data-title="Fakturačné údaje"
                    class="step-active flex items-center justify-center w-9 h-9 rounded-full border z-10">
                    1
                    <div class="absolute top-12 -left-8 text-black w-36 font-semibold">
                        Fakturačné údaje
                    </div>
                </div>
                <div data-title="Doprava"
                    class="flex items-center justify-center w-9 h-9 rounded-full border-2 border-black text-black bg-white z-10">
                    2
                    <div class="absolute top-12 left-60 text-black w-36 font-semibold">
                        Doprava
                    </div>
                </div>
                <div data-title="Platba"
                    class="flex items-center justify-center w-9 h-9 rounded-full border-2 border-black text-black bg-white z-10">
                    3
                    <div class="absolute top-12 -right-2 text-black w-36 font-semibold text-right">
                        Platba
                    </div>
                </div>
            </div>
