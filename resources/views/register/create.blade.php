<x-app-layout>
    <div class="md:px-24 md:py-24 py-8">
        <div class="w-88 md:w-160 mx-auto border rounded-xl">
            ...
            <form method="POST" action={{ route('register.store') }} class="px-6 pt-2 pb-6 space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" class="border w-full md:w-5/6 ml-2 rounded-lg py-2 px-2 text-gray-700"
                        value={{ old('name') }}>
                    @include('components.form-error-message', ['field' => 'name'])
                </div>
                <div class="flex flex-col">
                    <label class="font-semibold text-sm text-gray-800 mb-1">Email</label>
                    <input type="email" name="email" class="border w-full md:w-5/6 ml-2 rounded-lg py-2 px-2 text-gray-700"
                        value={{ old('email') }}>
                    @include('components.form-error-message', ['field' => 'email'])
                </div>
                <div class="flex flex-col">
                    <label class="font-semibold text-sm text-gray-800 mb-1">Heslo</label>
                    <input type="password" name="password" class="border w-full md:w-5/6 ml-2 rounded-lg py-2 px-2 text-gray-700">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="password" name="password_confirmation"
                        class="border w-full md:w-5/6 ml-2 rounded-lg py-2 px-2 text-gray-700">
                </div>
                <button
